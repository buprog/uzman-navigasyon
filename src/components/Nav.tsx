    ...
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          {mobileMenuOpen && user && (
            <div ref={mobileMenuRef} className="absolute right-4 top-14 mt-2 w-48 rounded-lg border border-slate-200 bg-white shadow-lg">
              <div className="py-1">
                <Link
                  href="/turlar"
          ...
          {dropdownOpen && (
            <div className="absolute right-16 top-14 mt-2 w-56 rounded-lg border border-slate-200 bg-white shadow-lg md:hidden">
              <div className="border-b border-slate-100 px-4 py-3">
                <p className="font-semibold text-slate-900">{displayName}</p>
                {user && !isDemoUser && (
                  <p className="mt-0.5 text-xs text-slate-500">{user.email}</p>
