...
// Feature flag: sesli navigasyon (TTS) kullanılabilir
export const VOICE_NAV_ENABLED = true;
...
export function speakInstruction(text: string, lang = "tr-TR", enabled = true): void {
  if (!enabled || !VOICE_NAV_ENABLED) {
    return;
  }
